...
{
    public class SkillsModuleFactory : ISkillsModuleFactory
    {
        public SkillsModuleViewModel Create(IPublishedElement element)
        {
            if (element == null) throw new ArgumentNullException(nameof(element));

            return new SkillsModuleViewModel
            {
                SkillGroups = GetPropertyValue<BlockListModel>(element, "skillGroups")
            };
        }
